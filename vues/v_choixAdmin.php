...
<div class="home">
    ...
    <p>
        Veuillez choisir si vous souhaitez ajouter un patient ou modifier la médication d'un patient ou encore ajouter un Administrateur.
    </p>
    <a href="index.php?uc=admin&action=creerAdm"><button>Créer un Administrateur</button></a>
